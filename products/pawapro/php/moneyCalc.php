			...
			<section id="condSection">
				...
				<div class="condInSec">
					...
					<table class="modern condList">
						...
						<tr>
							<td colspan="2">
								<div><input type="radio" class="isConfPickUp" name="confType" value="1">ピックアップキャラのみ</div>
								<div><input type="radio" class="isConfPickUp" name="confType" value="0" checked>ピックアップ以外も含む</div>
							</td>
						</tr>
						</tr>
					</table>
				...
				<div class="condInSec condOthers">
					...
					<div>
						...
						<p class="arrow_box">
							目標がSR45のとき、同キャラのPSRを合成素材として使う場合チェックを付けてください。<br>
						</p>
					</div>
					<div>
						<input type="checkbox" id="mixFlag" checked>素材合成をON<i class="fa fa-question-circle help" style="color:#0000ff; margin-left:1em;"></i>
						<p class="arrow_box">
							素材合成をONにすると、RやPRをその上位のレアリティに合成するようになります。<br>
							例えばPSR50を作る場合、手持ちのRをPRに合成してPR+5を作り、さらにPRとPR+5をSRに合成してSR+5を作ってPSRに合成するようにします。<br>
							同一レアリティへの合成は行いません。<br>
						</p>
					</div>
					<div>
						<input type="checkbox" id="simFlag">1万回やって平均を取る<i class="fa fa-question-circle help" style="color:#0000ff; margin-left:1em;"></i>
						<p class="arrow_box">
							1回の試行だとバラツキが出るため、1万回処理を実行して平均を出します。<br>
						</p>
					</div>
